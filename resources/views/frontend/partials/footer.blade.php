<div class="container">
    ...
    <div class="footer-top">
        ...
        <div class="footer-brand">
            ...
            <a href="#" class="logo">SMA YUPPENTEK 1</a>

            <p class="section-text">
                SMA Yuppentek 1 merupakan SMA terpercaya yang telah menghasilkan banyak lulusan di Indonesia dengan
                kualifikasi yang telah diterima di PTN dan PTS ternama.
            </p>
    ...
    <div class="footer-bottom">
        <p class="copyright">
            Copyright 2024 SMA Yuppentek 1. All Rights Reserved by <a href="#" class="copyright-link">E-Literasi</a>
        </p>
    </div>
